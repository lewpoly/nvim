...
vim.api.nvim_set_hl(0, "NavicIconsClass", { fg = "#ebcb8b" })
vim.api.nvim_set_hl(0, "NavicIconsMethod", { fg = "#d4d4d4" })
vim.api.nvim_set_hl(0, "NavicIconsProperty", { fg = "#75beff" })
vim.api.nvim_set_hl(0, "NavicIconsField", { fg = "#75beff" })
vim.api.nvim_set_hl(0, "NavicIconsConstructor", { fg = "#8fbcbb" })
vim.api.nvim_set_hl(0, "NavicIconsEnum", { fg = "#ebcb8b" })
vim.api.nvim_set_hl(0, "NavicIconsInterface", { fg = "#9cdcfe" })
vim.api.nvim_set_hl(0, "NavicIconsFunction", { fg = "#c586c0" })
vim.api.nvim_set_hl(0, "NavicIconsVariable", { fg = "#75beff" })
...
vim.api.nvim_set_hl(0, "NavicIconsKey", { fg = "#d4d4d4" })
vim.api.nvim_set_hl(0, "NavicIconsNull", { fg = "#d16969" })
vim.api.nvim_set_hl(0, "NavicIconsEnumMember", { fg = "#9cdcfe" })
vim.api.nvim_set_hl(0, "NavicIconsStruct", { fg = "#dcdcaa" })
