vim.list_extend(lew.lsp.automatic_configuration.skipped_servers, { "tsserver" })
...
-- Set a formatter.
local formatters = require "lew.lsp.null-ls.formatters"
formatters.setup {
...
-- Set a linter.
-- local linters = require("lew.lsp.null-ls.linters")
-- linters.setup({
